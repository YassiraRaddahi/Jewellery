...
Route::get('/orders/history', [OrdersController::class, 'orderHistoryIndex'])->middleware('auth')->name('orders.orderHistoryIndex');
Route::get('/orders/history/{ordernumber}', [OrdersController::class, 'orderHistoryShow'])->middleware('auth')->name('orders.order_history_show');
